...
This is a deep learning framework developed for the 'Neural Networks Software Project' at Saarland University (Winter Semester 2023-2024). The projects primary goal is to provide a scalable and resource-efficient pipeline for **Fake News Detection** in Taiwanese news sources by leveraging state-of-the-art Large Language Models (LLMs) and machine learning techniques.
...
* **Symbolic-Neural Hybridization:** As detailed in the technical `Report.pdf`, the model structure is designed to be interpretable, mapping neural outputs to logical clusters to better understand the decision-making process behind a "Fake" or "Real" news classification.
