...
##################################################
EXPERIMENT_NAME = f"testrun_streamlit_BERT_1_SimpleLinearHead_{time.time()}"
##################################################
PRINTING_FLAG = True
...
####
experiment = {
    "LM" : "BERT binary", # not used in code, define yourself
...
previous_checkpoint_file = "/nethome/phawlitschek/NN-SoftP/philipps_experiments_results/newer/streamlit_BERT_binary_SimpleLinearHead_1710938476.406034/best_checkpoint_streamlit_BERT_binary_SimpleLinearHead_1710938476.406034.pth"
