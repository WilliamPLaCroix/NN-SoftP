...
##################################################
EXPERIMENT_NAME = f"testrun_Gemma7B_1_SimpleLinearHead_{time.time()}"
##################################################
PRINTING_FLAG = True
...
####
experiment = {
    "LM" : "GEMMA 2B", # not used in code, define yourself
...
#checkpoint_path = "philipps_experiments_results/newer/EXP2Llama-7b_FULL_SimpleLinearHead_1710505393.4497905/checkpoint_EXP2Llama-7b_FULL_SimpleLinearHead_1710505393.4497905.pth"
...
lm = AutoModel.from_pretrained("google/gemma-2b", token=access_token, quantization_config=bnb_config)
###
####
#####
######
...
previous_checkpoint_file = "/nethome/phawlitschek/NN-SoftP/philipps_experiments_results/newer/7B_Gemma_EXP1_SimpleLinearHead_1710654846.556806/best_checkpoint_7B_Gemma_EXP1_SimpleLinearHead_1710654846.556806.pth.pth"
